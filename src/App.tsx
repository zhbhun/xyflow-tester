...
import FlowDemo from './pages/node/flow'
import GroupFlow from './pages/node/group'
...
function App() {
  return (
    <Routes>
      ...
      <Route path="/node/flow" element={<FlowDemo />} />
      <Route path="/node/group" element={<GroupFlow />} />
